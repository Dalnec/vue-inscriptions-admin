...
<template>
    <Listbox :options="listConcepts" option-value="value" option-label="label" v-model="selectedConcept" checkmark
             @update:modelValue="(value)=>emit('onConceptClick', {concept: value})"/>
</template>
