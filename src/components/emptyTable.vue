...
<template>
    <div class="flex h-20 w-full items-center justify-start rounded-lg gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 24 24"
             class="text-4xl text-surface-900 dark:text-white">
            ...
            <g style="fill: none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
